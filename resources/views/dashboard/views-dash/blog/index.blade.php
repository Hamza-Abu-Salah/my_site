...
@section('content')
    <div class="main-body">
        ...
        <div class="modal" id="modalBlogAdd">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Blog</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal"
                                type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <ul id="list_error_message"></ul>
                        <form id="formBlogAdd" enctype="multipart/form-data">
                            <div class="row">
        ...
        <!-- End Basic modal -->
        <div class="modal" id="modalBlogUpdate">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formBlogUpdate" enctype="multipart/form-data">
                            @method('PUT')
        ...
        <div class="modal" id="modalBlogDelete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger" id="deleteBlog">Delete</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button class="btn btn-info-gradient btn-block" id="ShowModalBlog"
                    ...
                    <div class="card-body">
                        <div class="table-responsive hoverable-table">
                                <table class="table table-hover" id="get_blog" style=" text-align: center;">
                                    <thead>
                                    <tr>
...
@section('js')
    ...
    <script src="{{URL::asset('assets/dashboard/local/blog.js')}}"></script>
@endsection
