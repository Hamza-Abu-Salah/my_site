...
@section('content')
    <div class="main-body">
        ...
        <div class="modal" id="modalTestimonialAdd">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Testimonial</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal"
                                type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <ul id="list_error_message"></ul>
                        <form id="formTestimonialAdd" enctype="multipart/form-data">
                            <div class="row">
        ...
        <!-- End Basic modal -->
        <div class="modal" id="modalTestimonialUpdate">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formTestimonialUpdate" enctype="multipart/form-data">
                            @method('PUT')
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success"
                                        id="updateTestimonial">Update</button>
                                <button type="button" class="btn btn-secondary"
                                        data-dismiss="modal">Close</button>
                            </div>
                        </form>
        ...
        <div class="modal" id="modalTestimonialDelete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger" id="deleteTestimonial">Delete</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button class="btn btn-info-gradient btn-block" id="ShowModalTestimonial"
                    ...
                    <div class="card-body">
                        <div class="table-responsive hoverable-table">
                                <table class="table table-hover" id="get_testimonial" style=" text-align: center;">
                                    <thead>
                                    <tr>
...
@section('js')
    ...
    <script src="{{URL::asset('assets/dashboard/local/testimonial.js')}}"></script>
@endsection
