...
@section('content')
    <div class="main-body">
        ...
        <div class="modal" id="modalBusinessAdd">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Business</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal"
                                type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <ul id="list_error_message"></ul>
                        <form id="formBusinessAdd" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="sub_title_en" required>
                                </div>
        ...
        <!-- End Basic modal -->
        <div class="modal" id="modalBusinessUpdate">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Update Business</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal"
                                type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <ul id="list_error_message2"></ul>
                        <form id="formBusinessUpdate" enctype="multipart/form-data">
                            @method('PUT')
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success"
                                        id="updateBusiness">Update</button>
                                <button type="button" class="btn btn-secondary"
                                        data-dismiss="modal">Close</button>
                            </div>
                        </form>
        ...
        <div class="modal" id="modalBusinessDelete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger" id="deleteBusiness">Delete</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button class="btn btn-info-gradient btn-block" id="ShowModalBusiness"
                    ...
                    <div class="card-body">
                        <div class="table-responsive hoverable-table">
                                <table class="table table-hover" id="get_business" style=" text-align: center;">
                                    <thead>
                                    <tr>
...
@section('js')
    ...
    <script src="{{URL::asset('assets/dashboard/local/business.js')}}"></script>
@endsection
