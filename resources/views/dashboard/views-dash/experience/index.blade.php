...
@section('content')
    <div class="main-body">
        ...
        <div class="modal" id="modalExperienceAdd">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formExperienceAdd" enctype="multipart/form-data">
                            <div class="row">
        ...
        <!-- End Basic modal -->
        <div class="modal" id="modalExperienceUpdate">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Update Experience</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal"
                                type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <ul id="list_error_message2"></ul>
                        <form id="formExperienceUpdate" enctype="multipart/form-data">
                            @method('PUT')
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success"
                                        id="updateExperience">Update</button>
                                <button type="button" class="btn btn-secondary"
                                        data-dismiss="modal">Close</button>
                            </div>
                        </form>
        ...
        <div class="modal" id="modalExperienceDelete" style="display: none;" aria-hidden="true">
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button class="btn btn-info-gradient btn-block" id="ShowModalExperience"
                    ...
                    <div class="card-body">
                        <div class="table-responsive hoverable-table">
                                <table class="table table-hover" id="get_experience" style=" text-align: center;">
                                    <thead>
                                    <tr>
...
@section('js')
    ...
    <script src="{{URL::asset('assets/dashboard/local/experience.js')}}"></script>
@endsection
