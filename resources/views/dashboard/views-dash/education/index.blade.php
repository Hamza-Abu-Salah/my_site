...
@section('content')
    <div class="main-body">
        ...
        <div class="modal" id="modalEducationAdd">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formEducationAdd" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Learn Resource :</label>
                                    <input type="text" class="form-control" name="Learn_resource_en" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Year Range :</label>
        ...
        <!-- End Basic modal -->
        <div class="modal" id="modalEducationUpdate">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Update Education</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal"
                                type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <ul id="list_error_message2"></ul>
                        <form id="formEducationUpdate" enctype="multipart/form-data">
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Learn Resource :</label>
                                    <input type="text" class="form-control" id="Learn_resource_en" name="Learn_resource_en" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Year Range :</label>
                                    <input type="text" class="form-control" id="year_range" name="year_range" required>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success"
                                        id="updateEducation">Update</button>
                                <button type="button" class="btn btn-secondary"
                                        data-dismiss="modal">Close</button>
                            </div>
                        </form>
        ...
        <div class="modal" id="modalEducationDelete" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger" id="deleteEducation">Delete</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button class="btn btn-info-gradient btn-block" id="ShowModalEducation"
                    ...
                    <div class="card-body">
                        <div class="table-responsive hoverable-table">
                                <table class="table table-hover" id="get_education" style=" text-align: center;">
                                    <thead>
                                    <tr>
                                        <th class="border-bottom-0">#</th>
                                        <th class="border-bottom-0">Title</th>
                                        <th class="border-bottom-0">Learn Resource</th>
                                        <th class="border-bottom-0">Description</th>
                                        <th class="border-bottom-0">Year Range</th>
...
@section('js')
    ...
    <script src="{{URL::asset('assets/dashboard/local/education.js')}}"></script>
@endsection
